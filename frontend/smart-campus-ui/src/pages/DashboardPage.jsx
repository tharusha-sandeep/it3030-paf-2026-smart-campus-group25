...
const STATS = [
  {
    ...
    label: "UPCOMING BOOKINGS", value: "3", sub: "scheduled this week", badge: null,
  },
  {
    color: "#f97316", bg: "#fff7ed", emoji: "📦",
    label: "AVAILABLE RESOURCES", value: "18", sub: "items ready",
    badge: { text: "INVENTORY", color: "#f97316", bg: "#fff7ed" },
  },
  {
    color: "#ef4444", bg: "#fff1f2", emoji: "🔔",
    label: "SYSTEM ALERTS", value: "5", sub: "unread updates",
...
const BOOKINGS = [
  {
    date: "Oct 24", title: "Advanced Physics Seminar",
    location: "Hall B, Engineering Wing", time: "09:00–11:30 AM",
    badge: "LECTURE THEATRE", badgeColor: "#3b82f6", badgeBg: "#eff6ff",
  },
  {
    date: "Oct 26", title: "IT Infrastructure Audit",
    location: "Data Center East", time: "02:00–04:00 PM",
    badge: "STAFF ONLY", badgeColor: "#6366f1", badgeBg: "#eef2ff",
  },
];

const FEED = [
  { dotColor: "#3b82f6", title: "HVAC Maintenance Completed", desc: "Science Block systems optimized", time: "2 hours ago" },
  { dotColor: "#ef4444", title: "New Booking Request", desc: "Dean's office requires Conference Hall A", time: "5 hours ago" },
];
...
const DashboardPage = () => {
  ...
  const layout = {
    ...
    brandTitle: { fontSize: "0.8rem", fontWeight: "700", color: "#0f172a", whiteSpace: "nowrap", lineHeight: 1.2 },
    brandSub: { fontSize: "0.625rem", color: "#94a3b8", whiteSpace: "nowrap" },
    navSection: { flex: 1, padding: "1rem 0.5rem", overflowY: "auto" },
    navItem: (active) => ({
      display: "flex", alignItems: "center", gap: "10px",
      padding: "9px 12px", borderRadius: "9px", marginBottom: "2px",
      cursor: "pointer", backgroundColor: active ? NAVY : "transparent",
      color: active ? "white" : "#475569", fontSize: "0.875rem",
      fontWeight: active ? "600" : "400", border: "none", width: "100%",
      textAlign: "left", transition: "background-color 0.15s, color 0.15s",
    }),
    sidebarBottom: { padding: "0.75rem 0.5rem 1rem", borderTop: "1px solid #f1f5f9" },
    bottomBtn: {
      display: "flex", alignItems: "center", gap: "10px",
      padding: "9px 12px", borderRadius: "9px", marginBottom: "2px",
      cursor: "pointer", color: "#475569", fontSize: "0.875rem",
      fontWeight: "400", border: "none", backgroundColor: "transparent",
    ...
    logoutBtn: {
      ...
      border: "none", backgroundColor: "#fff1f2", width: "100%",
      textAlign: "left", marginTop: "4px",
    },
    main: { marginLeft: "220px", flex: 1, display: "flex", flexDirection: "column", minHeight: "100vh" },
    topNav: {
      backgroundColor: "white", padding: "0 1.5rem", height: "60px",
      display: "flex", alignItems: "center", justifyContent: "space-between",
      borderBottom: "1px solid #f1f5f9", boxShadow: "0 2px 8px rgba(0,0,0,0.04)",
      position: "sticky", top: 0, zIndex: 50,
    },
    searchWrapper: {
      display: "flex", alignItems: "center", gap: "8px",
      backgroundColor: "#f8fafc", border: "1px solid #e2e8f0",
      borderRadius: "9px", padding: "8px 14px", width: "280px",
    },
    searchInput: {
      border: "none", outline: "none", backgroundColor: "transparent",
      fontSize: "0.875rem", color: "#475569", width: "100%",
    },
    ...
    welcomeTitle: { fontSize: "1.625rem", fontWeight: "700", color: "#0f172a", margin: 0, letterSpacing: "-0.02em" },
    ...
    statIconBox: (bg) => ({
      width: "44px", height: "44px", borderRadius: "11px", backgroundColor: bg,
    ...
    statBadge: (color, bg) => ({
      display: "inline-block", backgroundColor: bg, color, fontSize: "0.625rem",
    ...
    panelHeader: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "0.375rem" },
    panelTitle: { fontSize: "1rem", fontWeight: "700", color: "#0f172a", margin: 0 },
    panelSub: { fontSize: "0.8125rem", color: "#94a3b8", marginBottom: "1rem" },
    viewAllLink: {
      fontSize: "0.8125rem", color: "#3b82f6", textDecoration: "none", fontWeight: "500",
      display: "flex", alignItems: "center", gap: "4px", cursor: "pointer",
      border: "none", background: "none", padding: 0,
    },
    bookingCard: {
      display: "flex", gap: "14px", padding: "14px", borderRadius: "11px",
      border: "1px solid #f1f5f9", borderLeft: "3px solid #3b82f6",
      marginBottom: "10px", alignItems: "flex-start",
    },
    bookingDate: {
      fontSize: "0.6875rem", fontWeight: "700", color: "#3b82f6",
      backgroundColor: "#eff6ff", padding: "4px 8px", borderRadius: "6px", whiteSpace: "nowrap",
    },
    bookingTitle: { fontSize: "0.9375rem", fontWeight: "600", color: "#0f172a", margin: 0, marginBottom: "2px" },
    bookingLoc: { fontSize: "0.8125rem", color: "#64748b" },
    bookingTime: { fontSize: "0.75rem", color: "#94a3b8", marginTop: "4px" },
    ...
    launchpadTitle: { fontSize: "0.9375rem", fontWeight: "700", marginBottom: "0.25rem", color: "white" },
    ...
    feedTitle: { fontSize: "0.875rem", fontWeight: "600", color: "#0f172a" },
    feedDesc: { fontSize: "0.8125rem", color: "#64748b", marginTop: "1px" },
    feedTime: { fontSize: "0.75rem", color: "#94a3b8", marginTop: "2px" },
    fab: {
      ...
      display: "flex", alignItems: "center", justifyContent: "center",
      boxShadow: "0 6px 20px rgba(26,58,107,0.45)", zIndex: 200,
    },
  };
  ...
  return (
    <div style={layout.root}>
      ...
      <main style={layout.main}>
        <header style={layout.topNav}>
          <div style={layout.searchWrapper}>
            ...
            <input style={layout.searchInput} placeholder="Search operations..." aria-label="Search operations" />
          </div>
          ...
          <div style={layout.twoCol}>
              ...
              {BOOKINGS.map((b) => (
                <div key={b.title} style={layout.bookingCard}>
                  ...
                  <div>
                    ...
                    <span style={layout.bookingBadge(b.badgeColor, b.badgeBg)}>{b.badge}</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div style={layout.rightCol}>
              <div style={layout.launchpad}>
                ...
                <button style={layout.outlineBtn} onClick={() => navigate("/tickets/create")}>
                  Report Incident <ArrowRight size={15} />
                </button>
                <button style={{ ...layout.outlineBtn, marginBottom: 0 }} onClick={() => navigate("/tickets")}>
      ...
      {/* FAB — shortcut to create ticket */}
      <button style={layout.fab} aria-label="Report incident" onClick={() => navigate("/tickets/create")}>
        <Plus size={22} />
      </button>
    </div>
  );
