...
import {
  Search, Bell, Box, CalendarDays, Clock,
  ArrowRight, ChevronRight, Plus, Loader2,
  Package, AlertCircle
} from "lucide-react";
...
const DashboardPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const upcoming = allMyBookings.filter(
          (b) => b.status === "APPROVED" && b.bookingDate >= today
        );
        ...
        const sortedFeed = [...allMyBookings]
          .sort(
            (a, b) =>
  ...
  const styles = {
    ...
    launchpad: {
      ...
      padding: "24px", color: "white", marginBottom: "24px",
    },
    primaryBtn: {
    ...
    fab: {
      ...
      display: "flex", alignItems: "center", justifyContent: "center",
      boxShadow: "0 10px 15px -3px rgba(14, 165, 233, 0.4)", zIndex: 200,
    },
  };
  ...
  return (
    <div style={styles.root}>
          ...
          {loading ? (
            ...
            <>
              ...
              <div style={styles.twoCol}>
                {/* Left — Priority bookings */}
                <div style={styles.panel}>
                  <div style={styles.panelHeader}>
                    <p style={styles.panelTitle}>Priority Schedule</p>
                    <button style={{ background: "none", border: "none", color: "#0EA5E9", fontSize: "13px", fontWeight: "600", cursor: "pointer", display: "flex", alignItems: "center", gap: "4px" }}
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                  ...
                  <div style={styles.launchpad}>
                    ...
                    <button style={styles.primaryBtn} onClick={() => navigate("/tickets/create")}>
                      Report Incident <ArrowRight size={14} />
                    </button>
                    <button style={{ ...styles.primaryBtn, marginBottom: 0 }} onClick={() => navigate("/tickets")}>
                  ...
                  <div style={styles.panel}>
                    ...
                    {systemFeed.length > 0 ? (
                          ...
                          <div key={f.id} style={{ display: "flex", gap: "12px", padding: "12px 0", borderBottom: "1px solid #F1F5F9" }}>
                            ...
                            <div>
                              ...
                              <p style={{ fontSize: "12px", color: "#64748B", margin: 0 }}>
                                Status: <span style={{ color: st.color, fontWeight: "600" }}>{st.text}</span>
                              </p>
                            </div>
                          </div>
                        );
                      ...
                      <div style={{ textAlign: "center", color: "#94A3B8", fontSize: "13px" }}>No recent activity.</div>
                    )}
                  </div>
                </div>
              </div>
      ...
      <button style={styles.fab} onClick={() => navigate("/tickets/create")} title="Report Incident">
        <Plus size={24} />
      </button>
    </div>
  );
